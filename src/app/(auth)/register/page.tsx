          ...
          <form className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input id="first-name" type="text" autoComplete="given-name" placeholder="Ada" className="auth-input" />
              </div>
              <div>
                <label className="auth-label" htmlFor="last-name">Last name</label>
                <input id="last-name" type="text" autoComplete="family-name" placeholder="Lovelace" className="auth-input" />
              </div>
            </div>

            <div>
              <label className="auth-label" htmlFor="email">Email</label>
              <input id="email" type="email" autoComplete="email" placeholder="you@example.com" className="auth-input" />
            </div>

            <div>
              <label className="auth-label" htmlFor="password">Password</label>
              <input id="password" type="password" autoComplete="new-password" placeholder="Min. 8 characters" className="auth-input" />
              {/* Password strength bar */}
              <div className="flex gap-1 mt-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className={`h-0.5 flex-1 rounded-full ${i <= 1 ? "bg-accent" : "bg-black/10"}`} />
                ))}
              </div>
